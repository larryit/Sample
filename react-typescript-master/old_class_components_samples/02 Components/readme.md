...
In this   we will create a common header and about page react components.

We will take a startup point   _01 HelloReact_.
...
- Copy the content of the `01 HelloReact` folder to an empty folder for the  .
  ...
  return (
    <div className="row about-page top-buffer">
      ...
      <div className="col-xs-12">
        <h1>
          <small>
            This   takes the   "01 Hello react" as starting point.
            </small>
        </h1>
        <div className="col-xs-12">
          <h3>
