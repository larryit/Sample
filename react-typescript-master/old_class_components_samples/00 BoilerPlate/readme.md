...
In this   we are going to setup the basic plumbing to "build" our project and launch it in a dev server.

We won't install anything related about React, just some basic plumbing. In   01 we will start by importing
React and ReactDOM.
...
Then we will create a **index.ts**  .
...
```diff
{
  ...
  "version": "1.0.0",
  "description": "  working with React,TypeScript and Webpack",
  "scripts": {
