...
In this   we will breaking the list component into three: header, table and row components, member row entity passed via props.

We will take a startup point   _04 DisplayData_.
...
- Copy the content of the `04 DisplayData` folder to an empty folder for the  .
...
- We update`About` content to show   `05 Presentational Comp` highlights. You can see updates in `./src/components/about.tsx`.
