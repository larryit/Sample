...
In this   we will create our first react component and connect it with the DOM via react-dom.

We will take a startup point   _00 Boilerplate_.
...
- Copy the content of the `00 Boilerplate` folder to an empty folder for the  .
