...
In this   we are going to implement a basic login page, that will redirect the user to another page whenever the login has completed successfully.
...
We will take a starting point the   12 ReactRouter:
...
- Time to remove '  app' text from the main _html_.
